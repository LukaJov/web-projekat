$(document).on("click", "#user", function (event) {     // kada je submit-ovana forma za kreiranje novog zaposlenog
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/api/users",                 // URL na koji se šalju podaci
        ...
        success: function (response) {
            ...
            alert("Korisnik je uspešno kreiran!");// prikazujemo poruku uspeha korisniku
